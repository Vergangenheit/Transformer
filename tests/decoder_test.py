...
def run_test():
    ...
    encoder = trans_model.Encoder(en_vocab_size, config_trans.MODEL_SIZE, config_trans.NUM_LAYERS, config_trans.H)
    ...
    print(fr_vocab_size)
    decoder = trans_model.Decoder(fr_vocab_size, config_trans.MODEL_SIZE, config_trans.NUM_LAYERS, config_trans.H)
